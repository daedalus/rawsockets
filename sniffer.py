...
0x8100:{'proto':'','disec':None,'desc':'VLAN-tagged frame (IEEE 802.1Q) and Shortest Path Bridging IEEE 802.1aq[8]'},
...
0x8847:{'proto':'','disec':None,'desc':'MPLS unicast'},
0x8848:{'proto':'','disec':None,'desc':'MPLS multicast'},
0x8863:{'proto':'','disec':None,'desc':'PPPoE Discovery Stage'},
0x8864:{'proto':'','disec':None,'desc':'PPPoE Session Stage'},
0x8870:{'proto':'','disec':None,'desc':'Jumbo Frames (Obsoleted draft-ietf-isis-ext-eth-01)'},
0x887B:{'proto':'','disec':None,'desc':'HomePlug 1.0 MME'},
0x888E:{'proto':'','disec':None,'desc':'EAP over LAN (IEEE 802.1X)'},
...
0x88B9:{'proto':'','disec':None,'desc':'GSE (Generic Substation Events) Management Services'},
...
0x88E5:{'proto':'','disec':None,'desc':'MAC security (IEEE 802.1AE)'},
0x88E7:{'proto':'','disec':None,'desc':'Provider Backbone Bridges (PBB) (IEEE 802.1ah)'},
0x88F7:{'proto':'','disec':None,'desc':'Precision Time Protocol (PTP) over Ethernet (IEEE 1588)'},
0x88FB:{'proto':'','disec':None,'desc':'Parallel Redundancy Protocol (PRP)'},
0x8902:{'proto':'','disec':None,'desc':'IEEE 802.1ag Connectivity Fault Management (CFM) Protocol / ITU-T Recommendation Y.1731 (OAM)'},
0x8906:{'proto':'','disec':None,'desc':'Fibre Channel over Ethernet (FCoE)'},
0x8914:{'proto':'','disec':None,'desc':'FCoE Initialization Protocol'},
0x8915:{'proto':'','disec':None,'desc':'RDMA over Converged Ethernet (RoCE)'},
...
0x9100:{'proto':'','disec':None,'desc':'VLAN-tagged (IEEE 802.1Q) frame with double tagging'}
}

def proc_eth_frame(frame):
